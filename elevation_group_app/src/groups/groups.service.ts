...
export class GroupsService {
    _groups: GroupModel[] = [
        ...
        { id: 2,
            ...
            zip_code: 28277,
            description: "A singles group for growing " + 
            "in the word and building community."},
        { id: 3,
        campus: "Blakeny",
        demographic: "Women",
        ...
        { id: 4,
            ...
            meeting_date: "2020-09-02T19:16:57.985Z",
            zip_code: 28277,
            description: "A Women's group for studying " + 
        ...
        zip_code: 28275,
        description: "A group for new and continuing Christian" +
